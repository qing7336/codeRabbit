...
use function VIEW\Util\ArrayUtil\ViewArray\{array_column, array_diff, array_filter, array_intersect, array_key_exists, array_keys, array_merge, array_search, array_unique, array_values, count, date, explode, implode, in_array, reset, round};
	...
	$currentpage = htmlentities_utf8(xlate("Call Report - Building"));
...
<tr>
	<td width="40%" valign="top">
		...
		<tr>
			...
			$faultarea_options = array("" => xlate("Choose"))+getFaults($db, "area");
		...
		<tr>
			...
			<td><strong><?php print htmlentities_utf8(xlate("Options")); ?></strong></td>
		</tr>
		<tr>
			<td>
				<label><?php print checkbox("rptfilters[showgraphs]"); ?> <?php print htmlentities_utf8(xlate("Graphs")); ?></label><br />
				<label><?php print checkbox("rptfilters[inc_calldetails]"); ?> <?php print htmlentities_utf8(xlate("Call Details")); ?></label>
			</td>
			<td style="vertical-align: top;">
				<label><?php print checkbox('rptfilters[callratepurecallsonly]'); ?> <?php print html_xlate("Use only pure calls"); ?></label>
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
